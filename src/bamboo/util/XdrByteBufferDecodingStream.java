...
/*
 * $Header: /home/srhea/cvsroot/bamboo/src/bamboo/util/XdrByteBufferDecodingStream.java,v 1.2 2004/02/06 06:47:54 srhea Exp $
 *
 ...
 * a java.nio.ByteBuffer.  Cribbed by Sean Rhea from the class
 * org.acplt.oncrpc.XdrBufferDecodingStream.
 *
 * @version $Revision: 1.2 $ $Date: 2004/02/06 06:47:54 $ $State: Exp $ $Locker:  $
 * @author Harald Albrecht
 * @author Sean Rhea
 */
public class XdrByteBufferDecodingStream extends XdrDecodingStream {
     ...
     *   a multiple of four.
     */
    public void setXdrData(ByteBuffer buffer, int encodedLength) {
        //
    ...
    public void xdrDecodeOpaque(byte [] opaque, int offset, int length)
        ...
        if ( length > 0 ) {
            if ( bufferIndex <= bufferHighmark - alignedLength + 4 ) {
                buffer.get(opaque, offset, length);
            } else {
                 throw(new OncRpcException(OncRpcException.RPC_BUFFERUNDERFLOW));
            }
        }
