...
/*
 * $Header: /home/srhea/cvsroot/bamboo/src/bamboo/util/XdrInputBufferDecodingStream.java,v 1.1 2004/03/04 02:12:12 srhea Exp $
 *
 ...
 *
 * @version $Revision: 1.1 $ $Date: 2004/03/04 02:12:12 $ $State: Exp $ $Locker:  $
 * @author Harald Albrecht
 * @author Sean Rhea
 */
public class XdrInputBufferDecodingStream extends XdrDecodingStream {
     ...
     *   a multiple of four.
     */
    public XdrInputBufferDecodingStream(InputBuffer buffer, int encodedLength) {
     ...
     *   a multiple of four.
     */
    /*public XdrInputBufferDecodingStream(InputBuffer buffer) {
    ...
    public byte [] xdrDecodeOpaque(int length)
        ...
        for (int i = 0; i < alignedLength - length; ++i) 
            buffer.nextByte ();
        // buffer.position (buffer.position() + alignedLength - length);
        return bytes;
    }
